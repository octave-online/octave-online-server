...
require.config({
  ...
  bundles: {
    ...
    "ace-extras": ["ace/ext/language_tools", "ace/snippets", "ace/autocomplete", "ace/autocomplete/popup", "ace/autocomplete/util", "ace/autocomplete/text_completer", "ace/mode/octave", "ace/mode/matching_brace_outdent", "ace/mode/octave_highlight_rules", "ace/theme/crimson_editor", "ace/theme/merbivore_soft"]
  },
  shim: {
    // jQuery Plugins
    "jquery.md5": ["jquery"],
